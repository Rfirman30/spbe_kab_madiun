...
<div class="container d-flex justify-content-center justify-content-md-between">
	<div class="contact-info d-flex align-items-center">
		<i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">diskominfo@madiunkab.go.id</a></i>
	...
	<div class="social-links d-none d-md-flex align-items-center">
		...
		<a href="https://www.instagram.com/pemkabmadiun/?hl=id" class="instagram"><i class="bi bi-instagram"></i></a>
		<a href="https://www.youtube.com/c/pemkabmadiun" class="youtube"><i class="bi bi-youtube"></i></i></a>
	</div>
</div>
</section>
<div>
	<marquee direction="left" scrollamount="5" style='color:blue; font-weight:bold;'>Selamat Datang di Kabupaten Madiun</marquee>
</div>
<!-- End Top Bar -->
...
<div class="container-fluid container-xl d-flex align-items-center justify-content-between">
	...
	<ul>
		...
		<li>
			<a href="/kebijakan">Kebijakan SPBE</a>
		</li>
		<li>
